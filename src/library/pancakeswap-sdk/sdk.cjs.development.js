...
// eslint-disable-next-line @typescript-eslint/no-var-requires
var IUniswapV2Pair = _interopDefault(
  // eslint-disable-next-line @typescript-eslint/no-var-requires
...
var SOLIDITY_TYPE_MAXIMA =
  ...
  (_SOLIDITY_TYPE_MAXIMA[SolidityType.uint8] = /*#__PURE__*/ JSBI.BigInt(
    "0xff"
  )),
...
var CurrencyAmount = /*#__PURE__*/ (function (_Fraction) {
  ...
  function CurrencyAmount(currency, amount) {
    ...
    _this =
      _Fraction.call(
        this,
        parsedAmount,
        JSBI.exponentiate(TEN, JSBI.BigInt(currency.decimals))
      ) || this;
  ...
  _proto.toSignificant = function toSignificant(
    ...
    return _Fraction.prototype.toSignificant.call(
      this,
      significantDigits,
      format,
      rounding
  ...
  _proto.toFixed = function toFixed(decimalPlaces, format, rounding) {
    ...
    !(decimalPlaces <= this.currency.decimals)
      ...
      : void 0;
    return _Fraction.prototype.toFixed.call(
      this,
      decimalPlaces,
      format,
      rounding
  ...
  _proto.toExact = function toExact(format) {
    ...
    return new Big$1(this.numerator.toString())
      .div(this.denominator.toString())
      .toFormat(format);
  };
...
var Price = /*#__PURE__*/ (function (_Fraction) {
  ...
  Price.fromRoute = function fromRoute(route) {
    ...
    for (
      var _iterator = _createForOfIteratorHelperLoose(route.pairs.entries()),
        _step;
  ...
  _proto.quote = function quote(currencyAmount) {
    ...
    if (this.quoteCurrency instanceof Token) {
      return new TokenAmount(
        this.quoteCurrency,
        _Fraction.prototype.multiply.call(this, currencyAmount.raw).quotient
      );
    }
...
var Pair = /*#__PURE__*/ (function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    var tokens = tokenA.sortsBefore(tokenB)
      ? [tokenA, tokenB]
      : [tokenB, tokenA]; // does safety checks

    if (
      ((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null ||
      _PAIR_ADDRESS_CACHE === void 0
        ? void 0
        : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) ===
            null || _PAIR_ADDRESS_CACHE$t === void 0
        ? void 0
      ...
      PAIR_ADDRESS_CACHE = _extends(
        ...
        (_extends3[tokens[0].address] = _extends(
          {},
          (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) === null ||
            _PAIR_ADDRESS_CACHE2 === void 0
            ? void 0
...
var Route = /*#__PURE__*/ (function () {
  function Route(pairs, input, output) {
    ...
    for (
      ...
      var _output = currentInput.equals(pair.token0)
        ? pair.token1
        : pair.token0;
    ...
    this.input = input;
    this.output =
      output !== null && output !== void 0 ? output : path[path.length - 1];
  }
...
var Fetcher = /*#__PURE__*/ (function () {
  ...
  Fetcher.fetchTokenData = function fetchTokenData(
    chainId,
    address,
    provider,
    symbol,
    ...
    try {
      ...
      if (provider === undefined)
        provider = providers.getDefaultProvider(networks.getNetwork(chainId));

      var _temp4 =
        typeof ((_TOKEN_DECIMALS_CACHE2 = TOKEN_DECIMALS_CACHE) === null ||
        _TOKEN_DECIMALS_CACHE2 === void 0
          ? void 0
          : (_TOKEN_DECIMALS_CACHE3 = _TOKEN_DECIMALS_CACHE2[chainId]) ===
              null || _TOKEN_DECIMALS_CACHE3 === void 0
          ? void 0
      ...
      return Promise.resolve(
        _temp4
          ...
          : Promise.resolve(
              new contracts.Contract(address, ERC20, provider)
                .decimals()
                .then(function (decimals) {
                  ...
                  TOKEN_DECIMALS_CACHE = _extends(
                    ...
                    (_extends3[chainId] = _extends(
                      {},
                      (_TOKEN_DECIMALS_CACHE4 = TOKEN_DECIMALS_CACHE) ===
                        null || _TOKEN_DECIMALS_CACHE4 === void 0
                        ? void 0
                        : _TOKEN_DECIMALS_CACHE4[chainId],
                      ((_extends2 = {}),
                      (_extends2[address] = decimals),
                      _extends2)
                    )),
                    _extends3)
                  );
    ...
    try {
      if (provider === undefined)
        provider = providers.getDefaultProvider(
          networks.getNetwork(tokenA.chainId)
        );
      ...
      return Promise.resolve(
        ...
        var reserves0 = _ref[0],
          reserves1 = _ref[1];
        var balances = tokenA.sortsBefore(tokenB)
          ? [reserves0, reserves1]
          : [reserves1, reserves0];
        return new Pair(
